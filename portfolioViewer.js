(async () => {
  ...
  class JobPool {
     ...
     */ 
    static async exec() {
      // Execute jobs and save its promises
      const jobs = JobPool.#jobs.slice();
    ...
    static async execLoop() {
      await JobPool.exec(); 
      setTimeout(JobPool.execLoop);
    }
  }
    ...
    setup(dom) {
      ...
      dom.querySelectorAll(".hyperlink, .vref").forEach(link => {
        ...
        link.addEventListener("mouseenter", () => {
          ViewportPool.load(id, new MarkdownParser()); 
        });
      });
      ...
      dom
        ...
        .forEach(file => {
          ...
          file.addEventListener("mouseenter", () => {
            ViewportPool.load(ref, new MarkdownParser()); 
          });
        });
  ...
  class ViewportPool {
    ...
    static load(id, parser) {
      if (!ViewportPool.#viewports.has(id))
        JobPool.add(async () => await ViewportPool.#load(id, parser));
    }
  ...
  class Nav {
    ...
    static init() {
      ...
      Nav.#home.addEventListener("mouseenter", () => {
        ViewportPool.load("home", new MarkdownParser());
      });
      ...
      Nav.#about.addEventListener("mouseenter", () => {
        ViewportPool.load("about", new MarkdownParser());
      });
      ...
      Nav.#contact.addEventListener("mouseenter", () => {
        ViewportPool.load("contact", new MarkdownParser());
      });
      ...
      Nav.#copyright.addEventListener("mouseenter", () => {
        ViewportPool.load("copyright", new MarkdownParser());
      });
      ...
      Nav.#settings.addEventListener("mouseenter", () => {
        ViewportPool.load("settings", new SettingsParser());
      });
      ...
      Nav.#explorer.addEventListener("click", () => {
        ...
        Explorer.setOpen(newState);
      });
      Nav.#explorer.addEventListener("mouseenter", () => {
        ViewportPool.load("projects", new MarkdownParser());
      });
